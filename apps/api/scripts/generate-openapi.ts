  ...
  paths: {
    ...
    "/auth/register": {
      post: {
        ...
        security: [],
        requestBody: { content: { "application/json": { schema: toRef(RegisterSchema, "RegisterInput") } } },
    ...
    "/auth/login": {
      post: {
        ...
        security: [],
        requestBody: { content: { "application/json": { schema: toRef(LoginSchema, "LoginInput") } } },
        responses: { 200: { description: "Access token + refresh cookie" }, 401: { description: "Invalid credentials" } },
      },
    },
    "/auth/google": {
      post: {
        ...
        security: [],
        requestBody: { content: { "application/json": { schema: toRef(GoogleAuthSchema, "GoogleAuthInput") } } },
        responses: { 200: { description: "Access token + refresh cookie" }, 401: { description: "Invalid ID token" } },
      },
    },
    "/auth/refresh": {
      post: {
    ...
    "/conversations": {
      ...
      post: {
        ...
        security: [{ bearerAuth: [] }],
        requestBody: { content: { "application/json": { schema: toRef(CreateConversationSchema, "CreateConversationInput") } } },
    ...
    "/conversations/{id}": {
      ...
      patch: {
        ...
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
        requestBody: { content: { "application/json": { schema: toRef(CreateConversationSchema, "CreateConversationInput") } } },
        responses: { 200: { description: "Conversation renamed" }, 404: { description: "Not found" } },
      },
      delete: {
    ...
    "/chat/stream": {
      post: {
        ...
        security: [{ bearerAuth: [] }],
        requestBody: { content: { "application/json": { schema: toRef(ChatMessagesSchema, "ChatMessages") } } },
    ...
    "/providers": {
      ...
      post: {
        ...
        security: [{ bearerAuth: [] }],
        requestBody: { content: { "application/json": { schema: toRef(ProviderOptionsSchema, "ProviderOptions") } } },
    ...
    "/council/config": {
      ...
      put: {
        ...
        security: [{ bearerAuth: [] }],
        requestBody: { content: { "application/json": { schema: toRef(CouncilConfigSchema, "CouncilConfigInput") } } },
        responses: { 200: { description: "Config saved" }, 400: { description: "Validation error" } },
      },
      delete: {
