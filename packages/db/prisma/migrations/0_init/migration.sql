...
CREATE TABLE "CapabilityEntry" (
    ...
    CONSTRAINT "CapabilityEntry_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CapabilityEntry_modelId_providerId_key" ON "CapabilityEntry"("modelId", "providerId");
