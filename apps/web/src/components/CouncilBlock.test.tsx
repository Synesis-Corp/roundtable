...
const mockCouncil: CouncilInfo = {
  ...
  consensus: true,
  votes: [
    { modelId: "gpt-5", provider: "openai", displayName: "GPT-5", approachLabel: "Propone índices con cobertura parcial.", vote: "for", isWinner: true, proposalText: "# Tesis\nÍndices parciales." },
    { modelId: "claude-sonnet-4", provider: "anthropic", displayName: "Claude Sonnet 4", approachLabel: "Coincide; refuerza con particionado.", vote: "for", isWinner: false, debateText: "Claude evalúa las propuestas." },
    { modelId: "deepseek-v4", provider: "deepseek", displayName: "DeepSeek V4", approachLabel: "Defendió un esquema sin índices.", vote: "changed", isWinner: false, voteReason: "La propuesta de GPT-5 es más sólida.", voteImprovement: "Agregar un caso límite de borrado." },
    { modelId: "gemini-2.5", provider: "google", displayName: "Gemini 2.5", approachLabel: "Aporta consideraciones de coste.", vote: "for", isWinner: false },
  ],
