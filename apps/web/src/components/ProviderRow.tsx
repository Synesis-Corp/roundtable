...
function ProviderLogo({ id, name }: { id: string; name: string }) {
  ...
  return (
    ...
    >
      ...
      {failed && <span className="text-[13px] font-bold text-white">{getInitials(name)}</span>}
    </div>
  );
}
                  ...
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {showKey ? (
                      <path
                        ...
                        strokeWidth={2}
                        d="M3 3l18 18M10.6 10.6a2 2 0 002.8 2.8M9.9 4.2A10.5 10.5 0 0121 12c-.5 1.5-1.4 2.9-2.5 4M6.2 6.2A10.7 10.7 0 003 12c1.7 4.4 5 7 9 7 1.4 0 2.7-.3 3.9-.9"
                      />
                    ) : (
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M2.5 12C4.2 7.6 7.5 5 12 5s7.8 2.6 9.5 7c-1.7 4.4-5 7-9.5 7s-7.8-2.6-9.5-7zm9.5 3a3 3 0 100-6 3 3 0 000 6z"
                      />
                    )}
                  </svg>
                </button>
