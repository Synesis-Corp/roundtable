...
let hookState: {
  models: Array<{ id: string; name: string; provider: string; description: string; contextWindow: number; capabilities: string[] }>;
  activeIds: string[];
  loading: boolean;
  error: string | null;
...
function model(id: string) {
  return { id, name: id.toUpperCase(), provider: "openai", description: "", contextWindow: 1000, capabilities: [] };
}
